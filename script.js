...
async function updateCoinInsights() {
    try {
        ...
        document.getElementById('btc-oi').innerText = `$${(parseFloat(oiData.openInterest) * (prevPrices['btc'] || 95000) / 1000000000).toFixed(2)}B`;
...
function init() { runTimers(); updateCoinInsights(); setInterval(updateCoinInsights, 30000); }
